...
console.log("Attribution:");
{
  ...
  a = attributeEntry({ invited_by: txt("Sim Blaustein via David Birnbaum") }, hosts, { firmPattern: firm });
  ok(a.inviters.map((i) => i.name).join("|") === "Sim Blaustein|David Birnbaum" && a.org === null, "'X via Y' is two people", a);
  a = attributeEntry({ invited_by: txt("Alex Michael David Birnbaum") }, hosts, { firmPattern: firm });
  ok(a.inviter === null && a.org === null, "four capitalised words with no company word is left alone", a);
